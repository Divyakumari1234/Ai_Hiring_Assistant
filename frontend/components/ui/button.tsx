...
const buttonVariants=cva('shadcn-button',{variants:{variant:{default:'primary',outline:'secondary',ghost:'link'},size:{default:'',icon:'icon',sm:''}},defaultVariants:{variant:'default',size:'default'}})
